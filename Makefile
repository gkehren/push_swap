...
#    Updated: 2022/06/19 22:19:21 by gkehren          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

FILES:=	push_swap parsing sort_stack sort_utils rotate swap_push ft_split little_sort medium_sort abs_stack any_sort
